...
function CoursesFormEdit({ courseData }: { courseData: ICourseEdit }) {
  const [textAreaValue, setTextAreaValue] = useState("");
  const [isCourseEdited, setIsCourseEdited] = useState(false);
  ...
  return (
    <>
      ...
      <Divider sx={{ my: 4 }} />
      {isCourseEdited ? <CourseCardOne {...editCourseInfo} /> : <></>}
